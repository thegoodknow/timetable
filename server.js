...
def api_add_class():
    ...
    try:
        ...
        # 4. Find the Day object within the Week document
        # Query to find the week and the specific day
        query = {
            "weekStartDate": week_start_date,
            "days.date": formatted_day_date
        }

        # Update to push the new class into the matching day's 'classes' array
        update_push_class = {
        ...
        # 5. Handle case where the week or day does NOT exist
        if result.matched_count == 0:
            
            # Check if the week exists first
